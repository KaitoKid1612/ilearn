...
class TypingExerciseResultScreen extends StatelessWidget {
  final TypingExerciseResult result;

  const TypingExerciseResultScreen({super.key, required this.result});
  ...
  Widget _buildResultItem(int questionNumber, TypingQuestionResult result) {
    return Padding(
      padding: const EdgeInsets.all(16),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
